...
try {
    ...
    RAR.Router.post('/api/Causes',RAR.App.Controller.Causes.ConList.addCauses);

    // for edit exsisting Causes record 
    RAR.Router.put('/api/Causes/:id',RAR.App.Controller.Causes.ConList.editCauses);

    // delete single Causes record
    RAR.Router.delete('/api/Causes/:id/delete', RAR.App.Controller.Causes.ConList.deleteCauses);
