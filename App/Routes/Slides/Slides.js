...
try {
    ...
    RAR.Router.post('/api/Slides',RAR.App.Controller.Slides.ConList.addSlides);

    // for edit exsisting Slides record 
    RAR.Router.put('/api/Slides/:id',RAR.App.Controller.Slides.ConList.editSlides);

    // delete single Slides record
    RAR.Router.delete('/api/Slides/:id/delete', RAR.App.Controller.Slides.ConList.deleteSlides);
